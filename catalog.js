...
const catalog = {
  tops: [
    ...
    { swatch: true, color: "#AEC6CF", border: "#AEC6CF", name: "Light Blue",  sub: "Shirts",
      formality: ["Formal", "Semi-Formal", "Smart Casual", "Casual"], colorFamily: "cool", tone: "light", season: "All Season", description: "Light blue shirt — a classic office staple, works beautifully under a suit or with chinos.",
      type: "swatch" },
    { swatch: true, color: "#F4C2C2", border: "#F4C2C2", name: "Pale Pink",   sub: "Shirts",
      formality: ["Formal", "Semi-Formal", "Smart Casual", "Casual"], colorFamily: "warm", tone: "light", season: "All Season", description: "Pale pink shirt — soft and smart, works well under blazers and with dark trousers.",
      type: "swatch" },
    { swatch: true, color: "#E8A0A0", border: "#E8A0A0", name: "Mid Pink",    sub: "Shirts",
      formality: ["Formal", "Semi-Formal", "Smart Casual", "Casual"], colorFamily: "warm", tone: "light", season: "All Season", description: "Mid pink shirt — more casual than pale pink, best with chinos, jeans and casual blazers.",
      type: "swatch" },
    { swatch: true, color: "#B2C9B2", border: "#B2C9B2", name: "Sage Green",  sub: "Shirts",
      formality: ["Formal", "Semi-Formal", "Smart Casual", "Casual"], colorFamily: "warm", tone: "light", season: "Summer", description: "Sage green shirt — earthy and relaxed, works with chinos, casual jeans and linen blazers.",
      type: "swatch" },
    { swatch: true, color: "#6B8CAE", border: "#6B8CAE", name: "Steel Blue",  sub: "Shirts",
      formality: ["Formal", "Semi-Formal", "Smart Casual", "Casual"], colorFamily: "cool", tone: "medium", season: "All Season", description: "Steel blue shirt — works well with chinos, dark jeans and blazers.",
      type: "swatch" },
    ...
    { swatch: true, color: "#FFFFFF", border: "#e0e0e0", name: "White",       sub: "T-Shirts",
      formality: ["Formal", "Semi-Formal", "Smart Casual", "Casual"], colorFamily: "neutral", tone: "light", season: "All Season", description: "White t-shirt — casual essential, works with any jeans or casual pants.",
      type: "swatch" },
    { swatch: true, color: "#1c1c1e", border: "#444",    name: "Black",       sub: "T-Shirts",
      formality: ["Formal", "Semi-Formal", "Smart Casual", "Casual"], colorFamily: "neutral", tone: "dark", season: "All Season", description: "Black t-shirt — versatile casual top, works with most casual pants and sneakers.",
      type: "swatch" },
    { swatch: true, color: "#9E9E9E", border: "#9E9E9E", name: "Grey",        sub: "T-Shirts",
      formality: ["Formal", "Semi-Formal", "Smart Casual", "Casual"], colorFamily: "neutral", tone: "medium", season: "All Season", description: "Grey t-shirt — relaxed everyday casual wear.",
      type: "swatch" },
    { swatch: true, color: "#1B3A6B", border: "#1B3A6B", name: "Navy",        sub: "T-Shirts",
      formality: ["Formal", "Semi-Formal", "Smart Casual", "Casual"], colorFamily: "cool", tone: "dark", season: "All Season", description: "Navy t-shirt — clean and casual, works with beige, khaki and casual jeans.",
      type: "swatch" },
    { swatch: true, color: "#6B7C4A", border: "#6B7C4A", name: "Olive",       sub: "T-Shirts",
      formality: ["Formal", "Semi-Formal", "Smart Casual", "Casual"], colorFamily: "warm", tone: "medium", season: "All Season", description: "Olive t-shirt — earthy casual tone, works with beige, khaki and casual jeans.",
      type: "swatch" },
    { swatch: true, color: "#D2B48C", border: "#D2B48C", name: "Beige",       sub: "T-Shirts",
      formality: ["Formal", "Semi-Formal", "Smart Casual", "Casual"], colorFamily: "warm", tone: "light", season: "Summer", description: "Beige t-shirt — light and summery, works with navy, olive and casual jeans.",
      type: "swatch" },
  ],
  pants: [
  ...
  belts: [
    { file: "belt_leather_black_pierrecardin_platebuckle.png",     name: "Pierre Cardin Plate Buckle",   sub: "Leather",
      ...
      material: "leather", buckleStyle: "plate", width: "thin", pants: ["Formal Trousers"] },
    { file: "belt_leather_black_white_stitch.png",                 name: "Black White Stitch",           sub: "Leather",
      brand: "", formality: ["Smart Casual", "Casual"], color: "black", colorFamily: "neutral", tone: "dark", season: "All Season", description: "Wide black leather belt with white double stitching and silver pin buckle. Works well with chinos and jeans.",
    ...
    { file: "belt_leather_black_beige_stitch.png",                 name: "Black Beige Stitch",           sub: "Leather",
      brand: "", formality: ["Smart Casual", "Casual"], color: "black", colorFamily: "neutral", tone: "dark", season: "All Season", description: "Wide black leather belt with beige zigzag stitching and silver pin buckle. Works well with chinos and jeans.",
      material: "leather", buckleStyle: "pin", width: "wide", pants: ["Chinos", "Jeans"] },
    { file: "belt_leather_darkbrown_silver.png",                   name: "Dark Brown Leather",           sub: "Leather",
      brand: "", formality: ["Smart Casual", "Casual"], color: "dark brown", colorFamily: "warm", tone: "dark", season: "All Season", description: "Dark brown leather belt with cream stitching and silver pin buckle. Pairs well with warm-toned chinos and jeans.",
      material: "leather", buckleStyle: "pin", width: "wide", pants: ["Chinos", "Jeans"] },
    { file: "belt_leather_espresso_silver_diesel.png",             name: "Diesel Espresso",              sub: "Leather",
      brand: "Diesel", formality: ["Smart Casual", "Casual"], color: "espresso", colorFamily: "warm", tone: "dark", season: "All Season", description: "Espresso dark brown Diesel leather belt with silver pin buckle and branded keeper. Works with chinos and jeans.",
    ...
    { file: "belt_leather_tan_gunmetal.png",                       name: "Tan Leather Gunmetal",         sub: "Leather",
      brand: "", formality: ["Smart Casual", "Casual"], color: "tan", colorFamily: "warm", tone: "medium", season: "All Season", description: "Tan leather belt with gunmetal buckle, clean and minimal with no visible stitching. Works with chinos and jeans.",
      material: "leather", buckleStyle: "pin", width: "wide", pants: ["Chinos", "Jeans"] },
    { file: "belt_woven_navy_tommyhilfiger.png",                   name: "Navy Woven Tommy Hilfiger",    sub: "Woven & Canvas",
      ...
      material: "woven", buckleStyle: "pin", width: "medium", pants: ["Chinos", "Jeans"] },
    { file: "belt_canvas_stripe_navyredwhite_tommyhilfiger.png",   name: "Stripe Canvas Tommy Hilfiger", sub: "Woven & Canvas",
      ...
      material: "canvas", buckleStyle: "pin", width: "medium", pants: ["Chinos", "Jeans"] },
  ],
  shoes: [
