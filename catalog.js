...
const catalog = {
  ...
  belts: [
    ...
    { file: "belt_leather_tan_gunmetal.png",                       name: "Tan Leather Gunmetal",         sub: "Leather",
      ...
      material: "leather", buckleStyle: "pin", width: "wide", pants: ["Chinos", "Jeans"] },
    { file: "belt_leather_brown_ratchet_black_wetoper.png",         name: "Wetoper Brown Ratchet Black Buckle", sub: "Leather",
      brand: "Wetoper", formality: ["Formal", "Semi-Formal"], color: "brown", colorFamily: "warm", tone: "medium", season: "All Season", description: "Brown leather ratchet belt by Wetoper with black plate buckle. Works with formal trousers and chinos.",
      material: "leather", buckleStyle: "plate", width: "thin", pants: ["Formal Trousers", "Chinos"] },
    { file: "belt_leather_brown_ratchet_silver_wetoper.png",        name: "Wetoper Brown Ratchet Silver Buckle", sub: "Leather",
      brand: "Wetoper", formality: ["Formal", "Semi-Formal"], color: "brown", colorFamily: "warm", tone: "medium", season: "All Season", description: "Brown leather ratchet belt by Wetoper with brushed silver plate buckle. Works with formal trousers and chinos.",
      material: "leather", buckleStyle: "plate", width: "thin", pants: ["Formal Trousers", "Chinos"] },
