...
const catalog = {
  ...
  suits: [
    { file: "suit_dark_charcoal_purple_lining.png", name: "Dark Charcoal Suit",     sub: "Formal (Wool)",
      brand: "", formality: ["Formal"], color: "dark charcoal", colorFamily: "cool", tone: "dark", season: "All Season", description: "Very dark charcoal two-piece wool suit with purple lining visible at the lapel. The darkest and most formal suit in the collection — commanding and sharp.",
      fabric: "wool", pattern: "solid", cut: "slim" },
    { file: "suit_mid_blue.png",                    name: "Mid Blue Suit",           sub: "Formal (Wool)",
      brand: "", formality: ["Formal"], color: "mid blue", colorFamily: "cool", tone: "medium", season: "All Season", description: "Bright saturated mid blue two-piece wool suit. Vivid and classic — a confident choice for business and formal occasions.",
      fabric: "wool", pattern: "solid", cut: "slim" },
    { file: "suit_light_blue_grey.png",             name: "Light Blue Grey Suit",    sub: "Formal (Wool)",
      brand: "", formality: ["Formal"], color: "light blue grey", colorFamily: "cool", tone: "medium", season: "All Season", description: "Desaturated light blue-grey two-piece wool suit with a subtle weave texture. Softer and less saturated than the mid blue — fresh for daytime formal events.",
      fabric: "wool", pattern: "solid", cut: "slim" },
    { file: "suit_blue_grey_check.png",             name: "Blue Grey Check Suit",    sub: "Formal (Wool)",
      brand: "", formality: ["Formal"], color: "blue grey", colorFamily: "cool", tone: "medium", season: "All Season", description: "Muted blue-grey two-piece wool suit with a subtle windowpane check. Darker and more textured than the solid blue-grey — distinguished and refined.",
      fabric: "wool", pattern: "check", cut: "slim" },
    { file: "suit_light_grey.png",                  name: "Light Grey Suit",         sub: "Formal (Wool)",
      brand: "", formality: ["Formal"], color: "light grey", colorFamily: "neutral", tone: "light", season: "All Season", description: "Clean light grey two-piece wool suit with dark lining. Elegant and classic — ideal for weddings, daytime formal events and smart office days.",
      fabric: "wool", pattern: "solid", cut: "slim" },
    { file: "suit_mid_grey.png",                    name: "Mid Grey Suit",           sub: "Formal (Wool)",
      brand: "", formality: ["Formal"], color: "mid grey", colorFamily: "neutral", tone: "dark", season: "All Season", description: "Medium charcoal grey two-piece wool suit with a subtle texture. A boardroom staple — versatile and professional for everyday formal wear.",
      fabric: "wool", pattern: "solid", cut: "slim" },
    { file: "suit_beige_linen.png",                 name: "Beige Linen Suit",        sub: "Casual (Linen)",
      brand: "", formality: ["Smart Casual", "Casual"], color: "beige", colorFamily: "warm", tone: "light", season: "Summer", description: "Warm sandy beige linen two-piece suit with clearly visible linen texture. Lightweight and relaxed — perfect for summer weddings, garden parties and smart casual occasions.",
      fabric: "linen", pattern: "solid", cut: "slim" },
  ],
  jackets: [],
};
