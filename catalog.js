...
const catalog = {
  ...
  suits: [
    { file: "suit_wool_mid_blue.png",                    name: "Mid Blue Wool Suit",      sub: "Formal (Wool)",
      brand: "", formality: ["Formal"], color: "mid blue", colorFamily: "cool", tone: "medium", season: "All Season", description: "Mid blue two-piece wool suit with slim cut. A classic business suit, versatile for most formal occasions.",
      fabric: "wool", pattern: "solid", cut: "slim" },
    { file: "suit_wool_light_blue.png",                  name: "Light Blue Wool Suit",     sub: "Formal (Wool)",
      brand: "", formality: ["Formal"], color: "light blue", colorFamily: "cool", tone: "light", season: "All Season", description: "Light blue two-piece wool suit. Lighter and fresher looking than the mid blue, great for daytime formal events.",
      fabric: "wool", pattern: "solid", cut: "slim" },
    { file: "suit_wool_blue_grey_check.png",             name: "Blue Grey Check Suit",     sub: "Formal (Wool)",
      brand: "", formality: ["Formal"], color: "blue grey", colorFamily: "cool", tone: "medium", season: "All Season", description: "Blue-grey wool suit with a very subtle check texture. Sits between the blue and grey suits in tone.",
      fabric: "wool", pattern: "check", cut: "slim" },
