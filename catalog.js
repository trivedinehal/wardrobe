...
const catalog = {
  ...
  suits: [
    ...
    { file: "suit_mid_blue.png",                    name: "Mid Blue Suit",           sub: "Formal (Wool)",
      brand: "", formality: ["Formal"], color: "mid blue", colorFamily: "cool", tone: "medium", season: "All Season", description: "Mid blue two-piece wool suit. A classic business suit, bright and saturated — versatile for most formal occasions.",
      fabric: "wool", pattern: "solid", cut: "slim" },
    { file: "suit_light_blue_grey.png",             name: "Light Blue Grey Suit",    sub: "Formal (Wool)",
      brand: "", formality: ["Formal"], color: "light blue grey", colorFamily: "cool", tone: "light", season: "All Season", description: "Light blue-grey two-piece wool suit. Sits between blue and grey in tone, fresh and versatile for daytime formal events.",
      fabric: "wool", pattern: "solid", cut: "slim" },
