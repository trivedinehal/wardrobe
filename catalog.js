...
const catalog = {
  ...
  pants: [
    { file: "pants_denim_levis_dark_wash.png",            name: "Levi's Dark Wash",       sub: "Jeans", subsub: "Smart Casual",
      formality: ["Smart Casual", "Casual"], color: "dark indigo", colorFamily: "cool", tone: "dark", season: "All Season", description: "Deep indigo slim-straight Levi's denim, clean and dark enough to dress up with a blazer.",
    ...
    { file: "pants_denim_levis_dark_blue.png",            name: "Levi's Dark Blue",        sub: "Jeans", subsub: "Casual",
      formality: ["Smart Casual", "Casual"], color: "dark blue", colorFamily: "cool", tone: "dark", season: "All Season", description: "Dark blue straight-cut Levi's denim, casual everyday wear despite the darker wash.",
    ...
    { file: "pants_denim_westbay_dark_indigo.png",        name: "Westbay Dark Indigo",     sub: "Jeans", subsub: "Casual",
      formality: ["Smart Casual", "Casual"], color: "dark indigo", colorFamily: "cool", tone: "dark", season: "All Season", description: "Dark indigo slim-cut denim, casual in feel despite the dark colour.",
      fabric: "denim", pattern: "solid", cut: "slim", hem: "full", beltLoop: "wide" },
    { file: "pants_denim_levis_mid_blue.png",             name: "Levi's Mid Blue",         sub: "Jeans", subsub: "Smart Casual",
      formality: ["Smart Casual", "Casual"], color: "mid blue", colorFamily: "cool", tone: "medium", season: "All Season", description: "Medium blue straight Levi's denim, smart enough to dress up with a blazer.",
      fabric: "denim", pattern: "solid", cut: "straight", hem: "full", beltLoop: "wide" },
    { file: "pants_denim_levis_light_wash.png",           name: "Levi's Light Wash",       sub: "Jeans", subsub: "Smart Casual",
      formality: ["Smart Casual", "Casual"], color: "light blue", colorFamily: "cool", tone: "light", season: "All Season", description: "Light wash Levi's denim, clean and neat enough for smart casual looks.",
      fabric: "denim", pattern: "solid", cut: "straight", hem: "full", beltLoop: "wide" },
    ...
    { file: "pants_denim_casualjeans_light_blue.png",     name: "Light Blue Casual Jeans", sub: "Jeans", subsub: "Casual",
      formality: ["Casual"], color: "light blue", colorFamily: "cool", tone: "light", season: "All Season", description: "Very light blue casual jeans, relaxed and easy for everyday casual wear.",
    ...
    { file: "pants_chino_allensolly_black.png",           name: "Allen Solly Black Chino", sub: "Chinos",
      formality: ["Smart Casual", "Casual"], color: "black", colorFamily: "neutral", tone: "dark", season: "All Season", description: "Jet black Allen Solly chino with a clean straight cut, pairs well with both casual and smart casual looks.",
    ...
    { file: "pants_chino_allensolly_dark_olive.png",      name: "Allen Solly Dark Olive",  sub: "Chinos",
      formality: ["Smart Casual", "Casual"], color: "dark olive", colorFamily: "warm", tone: "dark", season: "All Season", description: "Dark olive green Allen Solly chino, earthy and versatile for smart casual outfits.",
      fabric: "chino", pattern: "solid", cut: "straight", hem: "full", beltLoop: "wide" },
    { file: "pants_chino_allensolly_khaki.png",           name: "Allen Solly Khaki",       sub: "Chinos",
      formality: ["Smart Casual", "Casual"], color: "khaki", colorFamily: "warm", tone: "medium", season: "All Season", description: "Classic khaki Allen Solly chino, a wardrobe staple that works with almost any top or blazer.",
      fabric: "chino", pattern: "solid", cut: "straight", hem: "full", beltLoop: "wide" },
    { file: "pants_chino_white_cotton.png",               name: "White Cotton Chino",      sub: "Chinos",
      formality: ["Smart Casual", "Casual"], color: "off-white", colorFamily: "neutral", tone: "light", season: "Summer", description: "Off-white cotton chino with a clean flat-front cut, great for summer smart casual looks.",
    ...
    { file: "pants_chino_beige_cotton.png",               name: "Beige Cotton Chino",      sub: "Chinos",
      formality: ["Smart Casual", "Casual"], color: "beige", colorFamily: "warm", tone: "light", season: "Summer", description: "Light beige cotton chino, warm-toned and versatile for relaxed smart casual summer outfits.",
      fabric: "cotton", pattern: "solid", cut: "straight", hem: "full", beltLoop: "wide" },
  ...
  belts: [
    { file: "belt_leather_black_silver_plain.png",                 name: "Black Leather Plain",          sub: "Formal",
      formality: ["Smart Casual", "Casual"], color: "black", colorFamily: "neutral", tone: "dark", season: "All Season", description: "Wide plain black leather belt with silver pin buckle. Fits jeans and chinos but too wide for formal trouser loops.",
      buckleStyle: "pin", width: "wide" },
    { file: "belt_leather_black_silver_stitched.png",              name: "Black Leather Stitched",       sub: "Formal",
      formality: ["Smart Casual", "Casual"], color: "black", colorFamily: "neutral", tone: "dark", season: "All Season", description: "Wide black leather belt with contrast stitching and silver pin buckle. Fits jeans and chinos but too wide for formal trouser loops.",
      buckleStyle: "pin", width: "wide" },
    { file: "belt_leather_darkbrown_silver.png",                   name: "Dark Brown Leather",           sub: "Formal",
      formality: ["Smart Casual", "Casual"], color: "dark brown", colorFamily: "warm", tone: "dark", season: "All Season", description: "Wide dark brown leather belt with silver pin buckle. Fits jeans and chinos but too wide for formal trouser loops.",
      buckleStyle: "pin", width: "wide" },
    { file: "belt_leather_black_platebuckle.png",                  name: "Black Leather Plate Buckle",   sub: "Formal",
      formality: ["Formal", "Smart Casual"], color: "black", colorFamily: "neutral", tone: "dark", season: "All Season", description: "Thin black leather belt with sleek plate buckle. Fits formal trouser and suit loops as well as jeans.",
      buckleStyle: "plate", width: "thin" },
    { file: "belt_leather_black_silver_diesel.png",                name: "Black Leather Diesel",         sub: "Smart Casual",
      formality: ["Smart Casual", "Casual"], color: "black", colorFamily: "neutral", tone: "dark", season: "All Season", description: "Wide black Diesel leather belt with silver pin buckle. Best with jeans and casual chinos.",
      buckleStyle: "pin", width: "wide" },
    { file: "belt_leather_tan_gunmetal.png",                       name: "Tan Leather Gunmetal",         sub: "Smart Casual",
      formality: ["Smart Casual", "Casual"], color: "tan", colorFamily: "warm", tone: "medium", season: "All Season", description: "Wide tan leather belt with gunmetal buckle. Best with jeans and chinos, warm toned.",
      buckleStyle: "pin", width: "wide" },
    { file: "belt_woven_navy_tommyhilfiger.png",                   name: "Navy Woven Tommy Hilfiger",    sub: "Casual",
      formality: ["Casual"], color: "navy", colorFamily: "cool", tone: "dark", season: "All Season", description: "Navy elastic woven Tommy Hilfiger belt with gunmetal buckle. Casual only, best with jeans.",
    ...
    { file: "belt_canvas_stripe_navyredwhite_tommyhilfiger.png",   name: "Stripe Canvas Tommy Hilfiger", sub: "Casual",
      formality: ["Casual"], color: "navy/red/white", colorFamily: "cool", tone: "medium", season: "Summer", description: "Navy, red and white striped canvas Tommy Hilfiger belt with tan leather trim. Casual only, summery.",
  ...
  shoes: [
    { file: "shoes_dress_laceup_florsheim_brown.png",              name: "Florsheim Brown Lace-Up",      sub: "Formal", subsub: "Dress Shoes",
      formality: ["Formal", "Smart Casual"], color: "tan brown", colorFamily: "warm", tone: "medium", season: "All Season", description: "Classic brown leather Oxford lace-up by Florsheim with a pointed toe and leather sole. Best with suits and dress trousers but works with dark chinos too.",
    ...
    { file: "shoes_dress_laceup_florsheim_black.png",              name: "Florsheim Black Lace-Up",      sub: "Formal", subsub: "Dress Shoes",
      formality: ["Formal", "Smart Casual"], color: "black", colorFamily: "neutral", tone: "dark", season: "All Season", description: "Sleek black leather Oxford lace-up by Florsheim with a pointed toe and leather sole. The most formal shoe in the collection.",
      closure: "lace-up", sole: "leather" },
    { file: "shoes_dress_slipon_colorado_black.png",               name: "Colorado Black Slip-On",       sub: "Formal", subsub: "Dress Shoes",
      formality: ["Formal", "Smart Casual"], color: "black", colorFamily: "neutral", tone: "dark", season: "All Season", description: "Black leather slip-on dress shoe by Colorado with a pointed toe. Smart and easy to wear with suits, formal trousers and dark chinos.",
    ...
    { file: "shoes_dress_slipon_florsheim_black.png",              name: "Florsheim Black Slip-On",      sub: "Formal", subsub: "Dress Shoes",
      formality: ["Formal", "Smart Casual"], color: "black", colorFamily: "neutral", tone: "dark", season: "All Season", description: "Black leather slip-on by Florsheim with a square toe. Formal and polished, works well with suits and smart casual.",
      closure: "slip-on", sole: "leather" },
    { file: "shoes_boots_chelsea_florsheim_brown.png",             name: "Florsheim Brown Chelsea",      sub: "Formal", subsub: "Boots",
      formality: ["Formal", "Smart Casual", "Casual"], color: "dark brown", colorFamily: "warm", tone: "dark", season: "All Season", description: "Rich dark brown leather chelsea boot by Florsheim. Highly versatile — works with suits, smart casual jeans, chinos and casual outfits.",
    ...
    { file: "shoes_boots_chelsea_hushpuppies_black.png",           name: "Hush Puppies Black Chelsea",   sub: "Formal", subsub: "Boots",
      formality: ["Formal", "Smart Casual", "Casual"], color: "black", colorFamily: "neutral", tone: "dark", season: "All Season", description: "Black leather chelsea boot by Hush Puppies. Clean and versatile — works with suits, smart casual and casual outfits.",
      closure: "chelsea", sole: "leather" },
    { file: "shoes_boots_chelsea_hushpuppies_black_elastic.png",   name: "Hush Puppies Black (Elastic)", sub: "Formal", subsub: "Boots",
      formality: ["Formal", "Smart Casual", "Casual"], color: "black", colorFamily: "neutral", tone: "dark", season: "All Season", description: "Black leather ankle boot by Hush Puppies with full elastic side panel. Easy to slip on, versatile across formal and casual looks.",
    ...
    { file: "shoes_boots_chelsea_hushpuppies_black_zip.png",       name: "Hush Puppies Black (Zip)",     sub: "Formal", subsub: "Boots",
      formality: ["Formal", "Smart Casual", "Casual"], color: "black", colorFamily: "neutral", tone: "dark", season: "All Season", description: "Black leather ankle boot by Hush Puppies with side zip. Versatile across formal and casual looks.",
    ...
    { file: "shoes_loafer_modaitaliano_tan_brown.png",             name: "Moda Italiano Tan Loafer",     sub: "Smart Casual", subsub: "Loafers",
      formality: ["Smart Casual", "Casual"], color: "tan", colorFamily: "warm", tone: "medium", season: "Summer", description: "Tan leather bit-loafer by Moda Italiano with gold hardware. Works beautifully with chinos, formal jeans and casual outfits.",
      closure: "slip-on", sole: "leather" },
    { file: "shoes_loafer_hushpuppies_blue.png",                   name: "Hush Puppies Blue Loafer",     sub: "Smart Casual", subsub: "Loafers",
      formality: ["Smart Casual", "Casual"], color: "navy blue", colorFamily: "cool", tone: "medium", season: "Summer", description: "Navy suede driver moccasin by Hush Puppies. Relaxed loafer style, best with chinos and smart casual jeans.",
    ...
    { file: "shoes_loafer_hushpuppies_brown.png",                  name: "Hush Puppies Brown Loafer",    sub: "Smart Casual", subsub: "Loafers",
      formality: ["Smart Casual", "Casual"], color: "dark brown", colorFamily: "warm", tone: "dark", season: "All Season", description: "Dark brown pebbled leather driver moccasin by Hush Puppies. Comfortable and casual, best with chinos and jeans.",
      closure: "slip-on", sole: "rubber" },
    { file: "shoes_sneaker_wildrhino_brown_leather_whitesole.png", name: "Wild Rhino Brown Leather",     sub: "Smart Casual", subsub: "Sneakers",
      formality: ["Smart Casual", "Casual"], color: "tan brown", colorFamily: "warm", tone: "medium", season: "All Season", description: "Clean tan leather sneaker by Wild Rhino with white rubber sole. Elevated — works great with dark jeans, chinos and casual outfits.",
      closure: "lace-up", sole: "rubber" },
    { file: "shoes_sneaker_wildrhino_olive.png",                   name: "Wild Rhino Olive",             sub: "Smart Casual", subsub: "Sneakers",
      formality: ["Casual"], color: "olive", colorFamily: "warm", tone: "medium", season: "All Season", description: "Distressed olive leather trainer by Wild Rhino with a rugged casual look. Best with casual jeans.",
      closure: "lace-up", sole: "rubber" },
    { file: "shoes_sneaker_adidas_black_white.png",                name: "Adidas Black & White",         sub: "Casual", subsub: "Sneakers",
      formality: ["Casual"], color: "black", colorFamily: "neutral", tone: "dark", season: "All Season", description: "Black suede Adidas sneaker with white 3-stripe detail. Classic casual streetwear sneaker.",
      closure: "lace-up", sole: "rubber" },
    { file: "shoes_sneaker_uspolo_white_rednavy.png",              name: "US Polo White (Red/Navy)",     sub: "Casual", subsub: "Sneakers",
      formality: ["Casual"], color: "white", colorFamily: "neutral", tone: "light", season: "Summer", description: "White US Polo sneaker with red and navy detailing. Casual and sporty, best for summer outfits.",
      closure: "lace-up", sole: "rubber" },
    { file: "shoes_sneaker_uspolo_black_whitelaces.png",           name: "US Polo Black",                sub: "Casual", subsub: "Sneakers",
      formality: ["Casual"], color: "black", colorFamily: "neutral", tone: "dark", season: "All Season", description: "Black US Polo sneaker with white laces and red accent. Casual everyday sneaker.",
      closure: "lace-up", sole: "rubber" },
    { file: "shoes_boots_casual_colorado_black.png",               name: "Colorado Black Casual Boot",   sub: "Casual", subsub: "Boots",
      formality: ["Casual"], color: "black", colorFamily: "neutral", tone: "dark", season: "All Season", description: "Black leather chelsea-style ankle boot by Colorado. More casual construction than the Hush Puppies — best with casual jeans.",
      closure: "chelsea", sole: "rubber" },
    { file: "shoes_athletic_colorado_white_blue.png",              name: "Colorado White & Blue",        sub: "Athletic",
      formality: ["Casual"], color: "white/blue", colorFamily: "cool", tone: "light", season: "All Season", description: "White and blue retro running shoe by Colorado. Sport and casual use only.",
      closure: "lace-up", sole: "rubber" },
    { file: "shoes_athletic_reebok_grey_teal.png",                 name: "Reebok Grey & Teal",           sub: "Athletic",
      formality: ["Casual"], color: "grey/teal", colorFamily: "cool", tone: "medium", season: "All Season", description: "Grey and teal Reebok retro runner with chunky sole. Sport and gym use only.",
      closure: "lace-up", sole: "rubber" },
  ],
  blazers: [
    { file: "blazer_formal_charcoal_grey.png",                 name: "Charcoal Grey Blazer", sub: "Formal",
      formality: ["Formal", "Smart Casual"], color: "charcoal grey", colorFamily: "cool", tone: "medium", season: "All Season", description: "Classic charcoal grey slim-fit blazer with notch lapel. Versatile — works with suits, dress trousers and smart casual jeans.",
      fabric: "wool", pattern: "solid", cut: "slim" },
    { file: "blazer_formal_mid_blue.png",                      name: "Mid Blue Blazer",       sub: "Formal",
      formality: ["Formal", "Smart Casual"], color: "mid blue", colorFamily: "cool", tone: "medium", season: "All Season", description: "Mid blue slim-fit blazer with a subtle texture. Pairs well with grey trousers, chinos and dark jeans.",
      fabric: "wool", pattern: "solid", cut: "slim" },
    { file: "blazer_formal_navy.png",                          name: "Navy Blazer",            sub: "Formal",
      formality: ["Formal", "Smart Casual"], color: "navy", colorFamily: "cool", tone: "dark", season: "All Season", description: "Deep navy slim-fit blazer. A wardrobe essential — works with almost every pant colour and style.",
      fabric: "wool", pattern: "solid", cut: "slim" },
    { file: "blazer_formal_dark_charcoal_burgundy_lining.png", name: "Dark Charcoal Blazer",  sub: "Formal",
      formality: ["Formal", "Smart Casual"], color: "dark charcoal", colorFamily: "cool", tone: "dark", season: "All Season", description: "Very dark charcoal blazer with burgundy lining detail. Sharp and formal, best with dark trousers and suits.",
      fabric: "wool", pattern: "solid", cut: "slim" },
    { file: "blazer_casual_blue_wool.png",                     name: "Blue Wool Blazer",       sub: "Casual",
      formality: ["Smart Casual", "Casual"], color: "cobalt blue", colorFamily: "cool", tone: "medium", season: "All Season", description: "Vibrant cobalt blue wool blazer with floral lining. A statement piece — best with neutral pants like khaki, beige or dark jeans.",
      fabric: "wool", pattern: "solid", cut: "slim" },
    { file: "blazer_casual_beige_linen.png",                   name: "Beige Linen Blazer",     sub: "Casual",
      formality: ["Smart Casual", "Casual"], color: "beige", colorFamily: "warm", tone: "light", season: "Summer", description: "Light beige linen blazer with floral lining. Lightweight and relaxed, perfect for summer smart casual outfits.",
      fabric: "linen", pattern: "solid", cut: "slim" },
    { file: "blazer_casual_grey_check.png",                    name: "Grey Check Blazer",      sub: "Casual",
      formality: ["Smart Casual", "Casual"], color: "light grey", colorFamily: "cool", tone: "light", season: "All Season", description: "Light grey windowpane check blazer with blue lining. Casual and stylish, best with dark jeans or navy chinos.",
      fabric: "wool", pattern: "check", cut: "slim" },
  ],
  suits: [
    { file: "suit_wool_mid_blue.png",                    name: "Mid Blue Wool Suit",      sub: "Formal (Wool)",
      formality: ["Formal"], color: "mid blue", colorFamily: "cool", tone: "medium", season: "All Season", description: "Mid blue two-piece wool suit with slim cut. A classic business suit, versatile for most formal occasions.",
      fabric: "wool", pattern: "solid", cut: "slim" },
    { file: "suit_wool_light_blue.png",                  name: "Light Blue Wool Suit",     sub: "Formal (Wool)",
      formality: ["Formal"], color: "light blue", colorFamily: "cool", tone: "light", season: "All Season", description: "Light blue two-piece wool suit. Lighter and fresher looking than the mid blue, great for daytime formal events.",
      fabric: "wool", pattern: "solid", cut: "slim" },
    { file: "suit_wool_blue_grey_check.png",             name: "Blue Grey Check Suit",     sub: "Formal (Wool)",
      formality: ["Formal"], color: "blue grey", colorFamily: "cool", tone: "medium", season: "All Season", description: "Blue-grey wool suit with a very subtle check texture. Sits between the blue and grey suits in tone.",
      fabric: "wool", pattern: "check", cut: "slim" },
    { file: "suit_wool_dark_charcoal_purple_lining.png", name: "Dark Charcoal Suit",       sub: "Formal (Wool)",
      formality: ["Formal"], color: "dark charcoal", colorFamily: "cool", tone: "dark", season: "All Season", description: "Very dark charcoal two-piece wool suit with purple lining detail. Sharp and commanding for important formal occasions.",
      fabric: "wool", pattern: "solid", cut: "slim" },
    { file: "suit_wool_light_grey.png",                  name: "Light Grey Suit",          sub: "Formal (Wool)",
      formality: ["Formal"], color: "light grey", colorFamily: "cool", tone: "light", season: "All Season", description: "Light grey two-piece wool suit. Elegant and classic, works well for weddings, events and formal office days.",
      fabric: "wool", pattern: "solid", cut: "slim" },
    { file: "suit_wool_mid_grey.png",                    name: "Mid Grey Suit",            sub: "Formal (Wool)",
      formality: ["Formal"], color: "mid grey", colorFamily: "cool", tone: "medium", season: "All Season", description: "Mid grey two-piece wool suit. A boardroom staple — professional and versatile for everyday formal wear.",
      fabric: "wool", pattern: "solid", cut: "slim" },
    { file: "suit_linen_beige.png",                      name: "Beige Linen Suit",         sub: "Casual (Linen)",
      formality: ["Smart Casual", "Casual"], color: "beige", colorFamily: "warm", tone: "light", season: "Summer", description: "Beige linen two-piece suit. Lightweight and relaxed, perfect for summer weddings, garden parties and smart casual occasions.",
      fabric: "linen", pattern: "solid", cut: "slim" },
  ],
  jackets: [],
};
